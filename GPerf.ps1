...
$Script:TaskName = "GPerfOptimization"
$Script:InstallDir = "$env:ProgramData\GPerf"
$Script:ScriptName = "GPerf.ps1"
...
function Install-Persistence {
    ...
    try {
        ...
        Register-ScheduledTask -TaskName $Script:TaskName -Action $action -Trigger $trigger -Principal $principal -Settings $settings -Description "GPerf Optimization (Gorstak)" -Force | Out-Null
...
function Uninstall-Persistence {
    ...
    Write-Host "[OK] GPerf uninstalled." -ForegroundColor Green
    exit 0
}
