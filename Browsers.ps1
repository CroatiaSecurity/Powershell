...
$Script:TaskName = "BrowserHardening"
$Script:InstallDir = "$env:ProgramData\Browsers"
$Script:ScriptName = "Browsers.ps1"
...
function Install-Persistence {
    ...
    try {
        ...
        Register-ScheduledTask -TaskName $Script:TaskName -Action $action -Trigger $trigger -Principal $principal -Settings $settings -Description "Browser Hardening (Gorstak)" -Force | Out-Null
...
function Uninstall-Persistence {
    ...
    Write-Host "[OK] Browsers uninstalled." -ForegroundColor Green
    exit 0
}
