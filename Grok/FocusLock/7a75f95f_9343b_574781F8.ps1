...
# Runs continuously as SYSTEM, logging foreground apps to %TEMP%\FocusLock.log the moment they gain focus.
...
# Main loop: Monitor foreground apps, log, whitelist, and manage network rules
while ($true) {
    # Get active process
    ...
    # Log network connections (every cycle for monitoring)
