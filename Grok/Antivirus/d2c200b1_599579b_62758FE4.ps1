...
# Central cache cleanup to prevent memory bloat (DeepSeek)
...
function Invoke-RealTimeFileMonitor {
    ...
    $knownBad = @{ "275A021BBFB6489E54D471899F7DB9D1663FC695EC2FE2A2C4538AABF651FD0F" = "EICAR-Test-File" }
...
function Invoke-ChaosMode {
    ...
    try {
        ...
        $expectedHash = "275A021BBFB6489E54D471899F7DB9D1663FC695EC2FE2A2C4538AABF651FD0F"
