...
# Runs continuously as SYSTEM, allowing network access only for the foreground process (browser/MMO) and whitelisted apps (OBS, Discord, Spotify, etc.).
...
# Whitelist: Browsers, MMOs, common apps, and updaters
$Whitelist = @(
    ...
    "GoogleUpdate", "MozillaMaintenance", "SteamService", "updater"  # Update services
)

# Directories to scan for additional .exe files (e.g., MMOs)
$AppDirs = @(
    "C:\Program Files",
    "C:\Program Files (x86)",
    "C:\Games"  # Add your MMO paths
)
